...
class Flight extends CI_Controller {
                ...
                if (isset($result_query[($no - 1)])) {
                    ...
                    if ($SessionStatus == "NO") {
                        ...
                        if (($time - $SessionTime) < 780) {
                            ...
                            $SecurityToken = (($result_query[($no - 1)]->Security_Token));
                            $sess_id = ($no - 1);
                            $Security_SignOut = '<SOAP:Envelope xmlns:SOAP="http://www.w3.org/2003/05/soap-envelope" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" 
 ...
 xmlns:xsd="http://www.w3.org/2001/XMLSchema">
     ...
     <SOAP:Header xmlns="http://webservices.amadeus.com/definitions">
								...
								$soapAction = "https://nodeD1.test.webservices.amadeus.com/1ASIWTRVTTZ";
 ...
 xmlns:xsd="http://www.w3.org/2001/XMLSchema">
     ...
     <SOAP:Header xmlns="http://webservices.amadeus.com/definitions">
								...
								$URL2 = "https://test.webservices.amadeus.com";
									// $URL2 = "https://production.webservices.amadeus.com";
								$soapAction = "https://nodeD1.test.webservices.amadeus.com/1ASIWTRVTTZ/VLSSOQ_04_1_1A";
								$ch2 = curl_init();
                                curl_setopt($ch2, CURLOPT_URL, $URL2);
                                curl_setopt($ch2, CURLOPT_TIMEOUT, 180);
                                curl_setopt($ch2, CURLOPT_HEADER, 0);
...
//echo $session_flag;
        ...
        if ($session_flag == "true") {
          ...
          $Security_Auth = '<SOAP:Envelope xmlns:SOAP="http://www.w3.org/2003/05/soap-envelope" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" 
 xmlns:awsse="http://xml.amadeus.com/2010/06/Session_v3"
 xmlns:wsse="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-secext-1.0.xsd"
 xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    ...
    <SOAP:Body>	
		...
		<Security_Authenticate>
		    ...
		    <passwordInfo>
				...
				$URL2 = "https://nodeD1.test.webservices.amadeus.com";
				// $URL2 = "https://production.webservices.amadeus.com";
...
xmlns:sec="http://xml.amadeus.com/2010/06/Security_v1" <!-- Omitted Namespaces-->">
                ...
                $request_stirng = "FMPCAQ_08_2_1A";
                  ...
                  $Fare_MasterPricerTravelBoardSearch = '<SOAP:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/"
...
xmlns="http://xml.amadeus.com/2010/06/Security_v1">
 ...
 <SOAP:Header xmlns="http://webservices.amadeus.com/definitions">
  ...
  <add:To">https://nodeD1.test.webservices.amadeus.com/1ASIWTRVTTZ</add:To>
  ...
  <SOAP:Body>     
	<Fare_MetaPricerCalendar xmlns="http://xml.amadeus.com/FMTCAQ_12_4_1A">
        ...
        $soapAction = "http://webservices.amadeus.com/1ASIWTRVTTZ/FMTCAQ_12_4_1A";

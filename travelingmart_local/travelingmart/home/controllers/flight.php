                    ...
                    if ($SessionStatus == "NO") {
                        ...
                        if (($time - $SessionTime) < 780) {
                            ...
                            $Security_SignOut = '<?xml version="1.0" encoding="utf-8"?>
														<SOAP-ENV:Envelope xmlns:SOAP-ENV="http://www.w3.org/2003/05/soap-envelope"														xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/"														xmlns:xenc="http://www.w3.org/2001/04/xmlenc"
xmlns:awsse="http://xml.amadeus.com/2010/06/Session_v3
xmlns:soap="http://schemas.xmlsoap.org/wsdl/soap/"
xmlns:xs="http://www.w3.org/2001/XMLSchema"
xmlns:tns="http://xml.amadeus.com"
xmlns:link="http://wsdl.amadeus.com/2010/06/ws/Link_v1"
xmlns:typ="http://xml.amadeus.com/2010/06/Types_v1"
xmlns:wsu="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-utility-1.0.xsd"
xmlns:wsp="http://schemas.xmlsoap.org/ws/2004/09/policy"
xmlns:wsa="http://www.w3.org/2007/05/addressing"
xmlns:amasec="http://xml.amadeus.com/2010/06/Security_v1" <!-- Omitted Namespaces-->">
...
xmlns:wsp="http://schemas.xmlsoap.org/ws/2004/09/policy"
xmlns:wsa="http://www.w3.org/2007/05/addressing"
xmlns:sec="http://xml.amadeus.com/2010/06/Security_v1" <!-- Omitted Namespaces-->">
...
//echo $session_flag;
        ...
        if ($session_flag == "true") {
            $Security_Auth = '<SOAP-ENV:Envelope xmlns:SOAP-ENV="http://www.w3.org/2003/05/soap-envelope" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" 
 xmlns:awsse="http://xml.amadeus.com/2010/06/Session_v3
 xmlns:xsd="http://www.w3.org/2001/XMLSchema">
          

     <SOAP-ENV:Header xmlns="http://webservices.amadeus.com/definitions">
...
$nonce64 = mt_rand();
$password='AMADEUS';  //(this comes from customer password)
               
//Password Digest encypt
$passwordDigest1 = base64_encode(sha1(pack('a*', $nonce64) . pack('a*',$timestamp).sha1(pack('a*',$password),true),true));
$messageId= uniqid();
  ...
  // end 10 march
            ...
            if ($_SESSION['journey_type'] == "Round") {
			  ...
			  <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:sec="http://xml.amadeus.com/2010/06/Security_v1" xmlns:typ="http://xml.amadeus.com/2010/06/Types_v1" xmlns:iat="http://www.iata.org/IATA/2007/00/IATA2010.1" xmlns:app="http://xml.amadeus.com/2010/06/AppMdw_CommonTypes_v3" xmlns:link="http://wsdl.amadeus.com/2010/06/ws/Link_v1" xmlns:ses="http://xml.amadeus.com/2010/06/Session_v3" xmlns:sat="http://xml.amadeus.com/FMPTBQ_14_1_1A">
			  <soapenv:Header xmlns:wsa="http://www.w3.org/2005/08/addressing">
		<sec:AMA_SecurityHostedUser>
			<sec:UserID POS_Type="1" RequestorType="U" PseudoCityCode="LUXXW38MT" AgentDutyCode="SU"/>
		</sec:AMA_SecurityHostedUser>
		<wsse:Security xmlns:wsse="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-secext-1.0.xsd" xmlns:wsu="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-utility-1.0.xsd">
			<wsse:UsernameToken>
				<wsse:Username>WSTTZTRV</wsse:Username>
				<wsse:Password Type="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-username-token-profile-1.0#PasswordDigest">'.$passwordDigest1.'</wsse:Password>
	<wsse:Nonce EncodingType="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-soap-message-security-1.0#Base64Binary">'.base64_encode($nonce64).'</wsse:Nonce>
				<wsu:Created>'.$timestamp.'</wsu:Created>
			</wsse:UsernameToken>			
		</wsse:Security>		
		<wsa:MessageID soapenv:mustUnderstand="1">'.$messageId.'</wsa:MessageID>
		<wsa:To soapenv:mustUnderstand="1">https://nodeD1.test.webservices.amadeus.com/1ASIWTRVTTZ</wsa:To>
		<wsa:Action soapenv:mustUnderstand="1">http://webservices.amadeus.com/FMTTBQ_12_4_1A</wsa:Action>
		<wsa:ReplyTo soapenv:mustUnderstand="1">
			<wsa:Address>http://www.w3.org/2005/08/addressing/anonymous</wsa:Address>
		</wsa:ReplyTo>		
	</soapenv:Header>		
			<soapenv:Body>
			<Fare_MetaPricerTravelBoardSearch xmlns="http://xml.amadeus.com/FMTTBQ_12_4_1A">
														<numberOfUnit>
															<unitNumberDetail>
	...
	<wsse:Nonce EncodingType="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-soap-message-security-1.0#Base64Binary">'.base64_encode($nonce64).'</wsse:Nonce>
		...
		<wsa:MessageID soapenv:mustUnderstand="1">'.$messageId.'</wsa:MessageID>
		<wsa:To soapenv:mustUnderstand="1">https://nodeD1.test.webservices.amadeus.com/1ASIWTRVTTZ</wsa:To>
		<wsa:Action soapenv:mustUnderstand="1">http://webservices.amadeus.com/FMTCAQ_12_4_1A</wsa:Action>
		<wsa:ReplyTo soapenv:mustUnderstand="1">
			<wsa:Address>http://www.w3.org/2005/08/addressing/anonymous</wsa:Address>
		</wsa:ReplyTo>		
	</soapenv:Header>		
			<soapenv:Body>			
			<Fare_MetaPricerCalendar xmlns="http://xml.amadeus.com/FMTCAQ_12_4_1A">
																<numberOfUnit>
																	<unitNumberDetail>
																		<numberOfUnits>' . $Pcount . '</numberOfUnits>
																		<typeOfUnit>PX</typeOfUnit>
 ...
 //$created = gmdate('Y-m-d\TH:i:s\Z');
  ...
  //$nonce = substr(md5(uniqid('AMADEUS', true)),0,16);
   //$nonce64 = base64_encode($nonce);
  // $nonce64 = 'NjRmNjY4YTJiMDZiNDdjMQ==';
   
//$password='AMADEUS';
   //$passwordDigest1 = base64_encode(sha1($nonce.$created.$password, true));
  // $passwordDigest1 = base64_encode(pack('H*', sha1($nonce . $timestamp . sha1($password, $raw_output=true))));
 // $nonce64 = mt_rand();
         ...
         */
 // $passwordDigest1 = base64_encode(sha1($nonce64 +  $timestamp + sha1($password)));
   //$passwordDigest1 = '8GpyiO5te5M9AyL9UgpQixzpjzQ=';
	 
  //$passwordDigest1 = base64_encode(pack('H*',sha1(pack('H*', $nonce) . pack('a*',$timestamp).pack('a*',$this->password))));
	...
	<wsse:Nonce EncodingType="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-soap-message-security-1.0#Base64Binary">'.base64_encode($nonce64).'</wsse:Nonce>
		...
		<wsa:ReplyTo soapenv:mustUnderstand="1">
			...
			<Fare_MetaPricerCalendar xmlns="http://xml.amadeus.com/FMTCAQ_12_4_1A">
                ...
                //$request_stirng = "FMPCAQ_08_2_1A"; //old string
               // $request_stirng = "FMPCAQ_14_1_1A"; // string for master tag
			   $request_stirng = "FMTCAQ_12_4_1A"; // string for the meta tag
				//exit;
            }// Calender
			
			
			 else if ($_SESSION['journey_type'] == "Calendarold") {
				 
				 
              $Fare_MasterPricerTravelBoardSearch = '<?xml version="1.0" encoding="utf-8"?>
														<SOAP-ENV:Envelope xmlns:SOAP-ENV="http://www.w3.org/2003/05/soap-envelope"
xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/"														xmlns:xenc="http://www.w3.org/2001/04/xmlenc"
xmlns:awsse="http://xml.amadeus.com/2010/06/Session_v3
xmlns:soap="http://schemas.xmlsoap.org/wsdl/soap/"
xmlns:xs="http://www.w3.org/2001/XMLSchema"
xmlns:tns="http://xml.amadeus.com"
...
xmlns:sec="http://xml.amadeus.com/2010/06/Security_v1" <!-- Omitted Namespaces-->">
		...
		//	$soapAction = "http://webservices.amadeus.com/1ASIWBBTTHX/" . $request_stirng;
			//echo "<pre>";
			//print_r($Fare_MasterPricerTravelBoardSearch);
			//exit;
			
			//$URL2 = "https://nodea1.test.webservices.amadeus.com";
			$URL2 = "https://nodeD1.test.webservices.amadeus.com/1ASIWTRVTTZ";
			//$soapAction= "http://webservices.amadeus.com/FMPTBQ_14_1_1A";
			//$soapAction= "http://webservices.amadeus.com/".$request_stirng;
			$soapAction= "http://webservices.amadeus.com/".$request_stirng;
					...
					for ($i = 0; $i < $count_flight_result; $i++) 
                    {
                        ...
                        else 
                        {
                            for ($j = 0; $j < $count_flight_details; $j++) 
                            {
                                ...
                                $flightDetails[$i]['operatingCarrier'][$j] = 
								$flight_details[$i]['flightDetails'][$j]['flightInformation']['companyId']['operatingCarrier'];

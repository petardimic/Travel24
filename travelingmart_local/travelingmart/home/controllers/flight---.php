...
class Flight extends CI_Controller {
	...
	function get_flight_availabilty1($rand_id,$api='')
	{
        ...
        $sourceOffice = 'ALVXW38MT';// MIA1S21AV for flight_hotel MIA1S21AV
	   ...
	   $pwd='AMADEUS';
	   $nonce='NnxNY25XI3s=';
	  // echo $timestamp='2014-10-08T10:51:28.658Z';
	   $timestamp=date('Y-m-d').'T'.date('h:i:s').'Z';
	   
	   $Hsdpwd = sha1($nonce +  time() + sha1($pwd) );

	  //  $Hsdpwd = base64_encode(sha1($nonce.$timestamp.$pwd, true)); 
...
xmlns:sec="http://xml.amadeus.com/2010/06/Security_v1" xmlns:typ="http://xml.amadeus.com/2010/06/Types_v1" xmlns:iat="http://www.iata.org/IATA/2007/00/IATA2010.1" xmlns:app="http://xml.amadeus.com/2010/06/AppMdw_CommonTypes_v3" xmlns:link="http://wsdl.amadeus.com/2010/06/ws/Link_v1" xmlns:ses="http://xml.amadeus.com/2010/06/Session_v3" xmlns:fmp="http://xml.amadeus.com/VLSSLQ_06_1_1A ">
  <SOAP-ENV:Header>
															
		<wsse:Security>
<wsse:UsernameToken> 
<wsse:Username>'.$username.'</wsse:Username>
<wsse:Password Type="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-username-token-profile-1.0#PasswordDigest">'.$Hsdpwd.'</wsse:Password>
<wsse:Nonce EncodingType="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-soap-message-security-1.0#Base64Binary">'.$nonce.'</wsse:Nonce>

 <wsu:Created>'.$timestamp.'</wsu:Created>
</wsse:UsernameToken>
</wsse:Security>	
<wsa:MessageID>90c88b35-8e08-1848-36c4-6bf0a9675caa</wsa:MessageID>
<wsa:To>http://webservices.amadeus.com/1ASIWTRVTTZ</wsa:To>
        <wsse:Session>
			<wsse:SessionId/>
			<wsse:SequenceNumber/>
		    <wsse:SecurityToken/>
     ...
     <SOAP-ENV:Body>
		<Security_Authenticate>
			...
			<sourceOffice>ALVXW38MT</sourceOffice>
			</originIdentification>
			<originatorTypeCode>U</originatorTypeCode>
			<originator>WSTTZTRV</originator>
			</userIdentifier>
			 <dutyCode>
			 <dutyCodeDetails>
...
//$soapAction = "http://webservices.amadeus.com/1ASIWBBTTHX/VLSSLQ_06_1_1A";
	...
	//$soapAction = "https://nodeD1.test.webservices.amadeus.com/1ASIWTRVTTZ/VLSSLQ_06_1_1A";
            $soapAction = "http://webservices.amadeus.com/1ASIWTRVTTZ/VLSSLQ_06_1_1A";
...
xmlns:sec="http://xml.amadeus.com/2010/06/Security_v1" <!-- Omitted Namespaces-->">
                ...
                $Fare_MasterPricerTravelBoardSearch = '<?xml version="1.0" encoding="utf-8"?>
														<SOAP-ENV:Envelope xmlns:SOAP-ENV="http://www.w3.org/2003/05/soap-envelope"
xmlns:sec="http://xml.amadeus.com/2010/06/Security_v1" xmlns:typ="http://xml.amadeus.com/2010/06/Types_v1" xmlns:iat="http://www.iata.org/IATA/2007/00/IATA2010.1" xmlns:app="http://xml.amadeus.com/2010/06/AppMdw_CommonTypes_v3" xmlns:link="http://wsdl.amadeus.com/2010/06/ws/Link_v1" xmlns:ses="http://xml.amadeus.com/2010/06/Session_v3" xmlns:fmp="http://xml.amadeus.com/FMTTBQ_12_2_1A"
...
<wsa:MessageID>90c88b35-8e08-1848-36c4-6bf0a9675caa</wsa:MessageID>
<wsa:To>http://webservices.amadeus.com/FMTTBQ_12_2_1A</wsa:To>
											<awsse:Session>
																		  <awsse:SessionId>'.$SessionId.'</awsse:SessionId>
																		  <awsse:SequenceNumber>'.$SequenceNumber.'</awsse:SequenceNumber>
																		  <awsse:SecurityToken>'.$SecurityToken.'</awsse:SecurityToken>
...
//$soapAction = "https://nodeD1.test.webservices.amadeus.com/1ASIWTRVTTZ/".$request_stirng;
$soapAction = "http://webservices.amadeus.com/1ASIWTRVTTZ/".$request_stirng;
            $ch2 = curl_init();
            curl_setopt($ch2, CURLOPT_URL, $URL2);
            curl_setopt($ch2, CURLOPT_TIMEOUT, 180);
            curl_setopt($ch2, CURLOPT_HEADER, 0);

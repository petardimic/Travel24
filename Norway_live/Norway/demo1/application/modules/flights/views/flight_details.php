...
<body onload="check_fromerror();">
                    ...
                    <div style="float:left; width:207px;"> <div class="left10" style="font-size:11px; margin-left:5px; margin-top:5px; font-weight:normal;">1 
                        <?php if($_SESSION['journey_type']=='OneWay') echo 'One Way'; ?> Ticket(s) 
                            ...
                            <span class="flight_booking_smalltxt" >
                               <?php echo $_SESSION['adults']; ?> Adult(s)&nbsp;&nbsp;&nbsp;<?php if($_SESSION['childs'] != 0) { ?><?php echo $_SESSION['childs']; ?> Child(s)&nbsp;&nbsp;&nbsp; <?php } ?> <?php if($_SESSION['infants'] !=0) { ?><?php echo $_SESSION['infants']; ?> Infant(s) <?php } ?>
                            </span></div>
                        ...
                        <?php 
                            if($_SESSION['childs'] != 0 && $_SESSION['infants']!=0)
                            {
                        ?>
                        ...
                        <div class="top20" style="border-bottom:1px solid #ccc; margin-top:5px;"> </div>
                         Child Fare<br />
                        <div class="flight_booking_smalltxt top10" style="margin-top:5px;"><span   style="margin-top:5px;">Base Fare</span>
                            <span class="left80" style="float:right;">&#36;<?php echo(($flightDetails->Child_FareAmount-$flightDetails->Child_TaxAmount)*$_SESSION['childs']); ?></span>
                        </div>
                        <div class="top10" style="border-bottom:1px solid #ccc; margin-top:5px;"> </div>

                        <div class="flight_booking_smalltxt top10" style="margin-top:5px;">
                        <span style="margin-top:5px;">Fee &  Surcharge</span>
                            <span class="left80" style="float:right; margin-left:0px;">&#36;<?php echo ($flightDetails->Child_TaxAmount*$_SESSION['childs']); ?></span>
                        </div>
                        <div class="top20" style="border-bottom:1px solid #ccc; margin-top:5px;"> </div>
                         Infant Fare<br />
                        <div class="flight_booking_smalltxt top10" style="margin-top:5px;"><span   style="margin-top:5px;">Base Fare</span>
                            <span class="left80" style="float:right;">&#36;<?php echo(($flightDetails->Infant_FareAmount-$flightDetails->Infant_TaxAmount)*$_SESSION['infants']); ?></span>
                        </div>
                        <div class="top10" style="border-bottom:1px solid #ccc; margin-top:5px;"> </div>

                        <div class="flight_booking_smalltxt top10" style="margin-top:5px;">
                        <span style="margin-top:5px;">Fee &  Surcharge</span>
                            <span class="left80" style="float:right; margin-left:0px;">&#36;<?php echo ($flightDetails->Infant_TaxAmount*$_SESSION['infants']); ?></span>
                        </div>
                        <div class="top20" style="border-bottom:1px solid #ccc; margin-top:5px;"> </div>
                        
                        <?php 
                            }
                            else if($_SESSION['childs'] != 0 && $_SESSION['infants']==0)
                            {
                       ?>
                        Adult Fare<br />
                        <div class="flight_booking_smalltxt top10" style="margin-top:5px;"><span   style="margin-top:5px;">Base Fare</span>
                            <span class="left80" style="float:right;">&#36;<?php echo(($flightDetails->Adult_FareAmount-$flightDetails->Adult_TaxAmount)*$_SESSION['adults']); ?></span>
                        </div>
                        <div class="top10" style="border-bottom:1px solid #ccc; margin-top:5px;"> </div>

                        <div class="flight_booking_smalltxt top10" style="margin-top:5px;">
                        <span style="margin-top:5px;">Fee &  Surcharge</span>
                            <span class="left80" style="float:right; margin-left:0px;">&#36;<?php echo ($flightDetails->Adult_TaxAmount*$_SESSION['adults']); ?></span>
                        </div>
                        <div class="top20" style="border-bottom:1px solid #ccc; margin-top:5px;"> </div>
                        Child Fare<br />
                        <div class="flight_booking_smalltxt top10" style="margin-top:5px;"><span   style="margin-top:5px;">Base Fare</span>
                       ...
                       ?>
                            <div class="flight_booking_smalltxt top10" style="margin-top:5px;"><span   style="margin-top:5px;">Base Fare</span>
                                <span class="left80" style="float:right;">&#36;<?php echo(($flightDetails->Total_FareAmount-$flightDetails->TaxAmount)*$_SESSION['adults']); ?></span>
                            </div>
                            <div class="top10" style="border-bottom:1px solid #ccc; margin-top:5px;"> </div>

                            <div class="flight_booking_smalltxt top10" style="margin-top:5px;">
                            <span style="margin-top:5px;">Fee &  Surcharge</span>
                                <span class="left80" style="float:right; margin-left:0px;">&#36;<?php echo ($flightDetails->TaxAmount*$_SESSION['adults']); ?></span>
                            </div>
                            <div class="top20" style="border-bottom:1px solid #ccc; margin-top:5px;"> </div>
                        <?php
                            }
        ...
        <iframe frameborder="0" height="500" width="650" src="<?php print base_url()?>Cancellation.php"></iframe>
					...
					$segmets=explode('<br>',$flightDetails->cicode);
                            ...
                            <div style="clear:both;"></div>
                            <div class="top10">
								 <span class="flight_booking_blue_txt">Please take time to read the following: <?php /*?><a href="#"  style="color:#f30000;  font-size:11px;">Cancellation Policy </a><?php */?>&nbsp;&nbsp;<?php /*?><a href="#"  style="color:#f30000; font-size:11px;"> Modification Policy</a>&nbsp;|&nbsp;<a href="#"  style="color:#f30000;  font-size:11px;">Baggage Allowance</a><?php */?></span>
							</div>    
                            <div class="clear"> </div>
                            <?php if($i< ($count-1)){ ?>
                ...
                <div class="flight_booking_bluebg top10">
                   ...
                   <div class="top10" style="margin-top:0px;">
                        <form name="terms_checking" method="POST" action="" id="terms_check">
                            <input name="terms_checking_v1" id="terms_checking_v1" type="checkbox" value="" /> <span class="flight_booking_blue_txt">I have read, accept and agree to abide by DSS DEMO.us's </span>
                        <a href="#login-box1" class="login-window" style="font-size:12px; color:#ffae00; font-weight:bold;">  Terms & conditions </a>
        ...
        <iframe frameborder="0" height="500" width="650" src="<?php print site_url()?>/flights/terms_conditions"></iframe>
                        ...
                        <span style="color:#fff;">and</span> <a href="#login-box2" class="login-window1" style="font-size:12px; color:#ffae00; font-weight:bold;">privacy policy </a>
        ...
        <iframe frameborder="0" height="500" width="650" src="<?php print site_url()?>/flights/privacy_policy"></iframe>
				...
				if($this->session->userdata('customer_id') != '' || $_SESSION['user_email']) {
                    ?>
                    <br />
                    <span class="book_btn fleft" style="width:100px; "><a href="#" onclick="return submit_payment();" >Proceed to Payment</a></span>
                ...
                <div class="detail_area top10">
                    <form name="guest_form" id="contine_guest" method="POST" action="<?php echo site_url(); ?>/flights/pro_pre_booking/<?php echo $flightDetails->id; ?>/<?php echo $flightDetails->rand_id; ?>" class='form-horizontal form-validate'>
                        <div class="top30 fleft left20">
                            ...
                            <div class="clear"></div>
                            <button onclick="javascript:return contine_guest_submit();" class="flight_booking_redbtn top20" style="margin-top:10px;"> Continue as Guest </button>
...
password, Please use forgot password option.</span>"; }  ?></a>
                    ...
                    <form name="user_form" id="user_form" method="POST" action="<?php echo site_url(); ?>/flights/pro_pre_booking/<?php echo $flightDetails->id; ?>/<?php echo $flightDetails->rand_id; ?>" class='form-horizontal form-validate'>
                        <div class="top30 fleft left20">
                            ...
                            <div class="top30" style="margin-top:12px; font-weight:normal; line-height:15px;"> Welcome back! Please log-in to your  DSS DEMOonline <br />
                            ...
                            <div class="clear"></div>
                            <button onclick="javascript:return contine_user_submit();" class="flight_booking_redbtn top20 fleft"> Login </button>

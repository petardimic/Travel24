<?php
    if($stops!='')
    {
        foreach($stops as $stop)
        {
            ...
            {
?>
        <div class="top10"><input type="checkbox" name="stops_filter" class="stops_nm" style="padding-top:5px;" value="<?php echo $stop->stops; ?>" checked  onclick="return filter_new();"/>
            <?php

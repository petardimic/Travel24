<?php
    if($airline!='')
    {
        ...
        foreach($flights as $line1)
        {
            ...
            {
?>
				<div class="top10"><input type="checkbox" name="airline_filter" class="airline_nm" style="padding-top:5px;" value="<?php echo $line1; ?>" checked  onclick="return filter();"/><?php echo($line1=='Nacil Air India' ? 'Air India' : $line1); ?></div>
<?php
            }
        }
    }

...
<body onload="loadData();">
        ...
        <div class="inner_wrapper">
            ...
            <div class="left_part"> 
             ...
             <div class="left_header1_bg top20"><span class="left20">Hotel Details <?php  $tocityval = $this->session->userdata('tocityval'); 
             $city = explode('-',$tocityval);
		echo $city1 = $city[0];?></span></div>
                <div style="clear:both;"></div>
                <div class="lblue1_bg " id="hotel_details">
					<div id="progressbar2" style="display:none;" align="center"><img src="<?php echo base_url();?>assets/images/290.gif"  /></div>
                    <?php /* ?><div class="wid80 fleft">

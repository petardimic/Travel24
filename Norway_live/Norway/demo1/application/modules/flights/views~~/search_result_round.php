...
<!-- For slider filter and sorting js--> 
    <script type="text/javascript" src="http://ajax.aspnetcdn.com/ajax/jquery.ui/1.10.0/jquery-ui.js"></script>
            ...
            <div class="left_part"> 
             ...
             <div class="left_header1_bg top20"><span class="left20">Hotel Details Hyderabad</span></div>
                ...
                <div class="blue_bg top20 left5">
                    <div class="lblue_bg">
                        <div class="left_header"><strong>Price Range (Onward)</strong></div>
                ...
                <div class="blue_bg top20 left5">
                    <div class="lblue_bg">
                        <div class="left_header"><strong>Price Range (Return)</strong></div>
                ...
                <div id='cssmenu' style="margin-top:10px;">
                    <ul>
                        <li class='has-sub'><a href=''><span>Your Search Details</span></a>
                            <ul>
                                <div>Departure From : <?php echo $fromCity; ?></div>
                                <div>Arrival To : <?php echo $toCity; ?></div>
                                <div>Journey Type : <?php echo $_SESSION['journey_type']; ?></div>
                                <div>Onward Date : <?php echo $_SESSION['sd']; ?></div>
                                <div>Return Date : <?php echo $_SESSION['ed']; ?></div>
                                <div>Cabin Class : <?php echo $_SESSION['cabin']; ?></div>
                                <div>Adults : <?php echo $_SESSION['adults']; ?></div>
                                <div>Childs : <?php echo $_SESSION['childs']; ?></div>
                                <div>Infants : <?php echo $_SESSION['infants']; ?></div>
                            </ul>
                            <div style="clear:both;"></div>
                        </li>
                        ...
                        <li class='has-sub'><a href='#'><span>Fare Type</span></a>
                            <ul>
                                <div class="top10"><input type="checkbox" name="airline_filter" class="faretype_nm" style="padding-top:5px;" value="NRP" checked  onclick="return filterRound();"/>Refundable</div>
                                <div class="top10"><input type="checkbox" name="airline_filter" class="faretype_nm" style="padding-top:5px;" value="RP" checked  onclick="return filterRound();"/>Non-Refundable</div>
                            </ul>
                        </li>
                ...
                <div class="right_main_bar top20">
                    ...
                    <div class="sort_bar top10 clear" style="margin-top:10px;">
                        ...
                        <div class="wid108 right_devider center_txt fleft">
                            <a href="javascript:void(0);" title="Sort By Airline" rel="data-airline" data-order="asc" class="FlightSorting" style="text-decoration:none; color:#3d3d3d;"><img src="<?php echo base_url();?>assets/images/uparror.png" /> &nbsp;Airline&nbsp; <img src="<?php echo base_url();?>assets/images/downarror.png" /> </a>
                        </div>
                        <div class="wid108 right_devider center_txt fleft">
                            <a href="javascript:void(0);" title="Sort By Departure" rel="data-departure" data-order="asc" class="FlightSorting" style="text-decoration:none; color:#3d3d3d;"><img src="<?php echo base_url();?>assets/images/uparror.png" /> &nbsp;Departure&nbsp; <img src="<?php echo base_url();?>assets/images/downarror.png" /> </a>
                        </div>
                        <div class="wid108 right_devider center_txt fleft">
                            <a href="javascript:void(0);" title="Sort By Arrival" rel="data-arrival" data-order="asc" class="FlightSorting" style="text-decoration:none; color:#3d3d3d;"><img src="<?php echo base_url();?>assets/images/uparror.png" /> &nbsp;Arrival&nbsp; <img src="<?php echo base_url();?>assets/images/downarror.png" /> </a>
                        </div>
                        <div class="wid108 right_devider center_txt fleft">
                            <a href="javascript:void(0);" title="Sort By Duration" rel="data-duration" data-order="asc" class="FlightSorting" style="text-decoration:none; color:#3d3d3d;"><img src="<?php echo base_url();?>assets/images/uparror.png" /> &nbsp;Duration &nbsp; <img src="<?php echo base_url();?>assets/images/downarror.png" /></a>
                        </div>
                        <div class="wid108 right_devider center_txt fleft">
                            <a href="javascript:void(0);" title="Sort By Price" rel="data-price" data-order="asc" class="FlightSorting" style="text-decoration:none; color:#3d3d3d;"><img src="<?php echo base_url();?>assets/images/uparror.png" /> &nbsp;Price &nbsp; <img src="<?php echo base_url();?>assets/images/downarror.png" />  </a>
                        </div>
                        <div class="wid108 right_devider center_txt fleft">
                            <a href="javascript:void(0);" title="Sort By Stops" rel="data-stops" data-order="asc" class="FlightSorting" style="text-decoration:none; color:#3d3d3d;"><img src="<?php echo base_url();?>assets/images/uparror.png" /> &nbsp;Stops &nbsp; <img src="<?php echo base_url();?>assets/images/downarror.png" /> </a>
                        </div>
                    </div>
                    <div class="clear"></div>
                   <!--####################### FLIGHT LIST START  #################################-->

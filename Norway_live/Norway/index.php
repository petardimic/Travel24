...
if($_SERVER['HTTP_HOST']=='localhost' || $_SERVER['HTTP_HOST']=='192.168.0.108')
{
	...
	define('WEB_URL','http://'.$_SERVER['HTTP_HOST'].'/Norway/index.php/');
	define('WEB_DIR','http://'.$_SERVER['HTTP_HOST'].'/Norway/');
	define('WEB_URL_ADMIN',"http://".$_SERVER['HTTP_HOST']."/Norway/admin/index.php/");
	define('WEB_DIR_ADMIN',"http://".$_SERVER['HTTP_HOST']."/Norway/admin/");
}
